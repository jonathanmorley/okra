...
pub struct Role {
  ...
  #[serde(rename = "status")]
  status: Option<::models::RoleStatus>,
  #[serde(rename = "type")]
  _type: Option<String>
}
...
impl Role {
  ...
  pub fn set_status(&mut self, status: ::models::RoleStatus) {
    self.status = Some(status);
  }

  pub fn with_status(mut self, status: ::models::RoleStatus) -> Role {
    self.status = Some(status);
    self
  }

  pub fn status(&self) -> Option<&::models::RoleStatus> {
    self.status.as_ref()
  }
