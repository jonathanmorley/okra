...
pub struct Session {
  ...
  #[serde(rename = "amr")]
  amr: Option<Vec<::models::SessionAuthenticationMethod>>,
  ...
  id: Option<String>,
  #[serde(rename = "idp")]
  idp: Option<::models::SessionIdentityProvider>,
  ...
  login: Option<String>,
  #[serde(rename = "status")]
  status: Option<::models::SessionStatus>,
  #[serde(rename = "userId")]
...
impl Session {
  ...
  pub fn set_amr(&mut self, amr: Vec<::models::SessionAuthenticationMethod>) {
    self.amr = Some(amr);
  }

  pub fn with_amr(mut self, amr: Vec<::models::SessionAuthenticationMethod>) -> Session {
    self.amr = Some(amr);
    self
  }

  pub fn amr(&self) -> Option<&Vec<::models::SessionAuthenticationMethod>> {
    self.amr.as_ref()
  }
  ...
  pub fn set_idp(&mut self, idp: ::models::SessionIdentityProvider) {
    self.idp = Some(idp);
  }

  pub fn with_idp(mut self, idp: ::models::SessionIdentityProvider) -> Session {
    self.idp = Some(idp);
    self
  }

  pub fn idp(&self) -> Option<&::models::SessionIdentityProvider> {
    self.idp.as_ref()
  }
  ...
  pub fn set_status(&mut self, status: ::models::SessionStatus) {
    self.status = Some(status);
  }

  pub fn with_status(mut self, status: ::models::SessionStatus) -> Session {
    self.status = Some(status);
    self
  }

  pub fn status(&self) -> Option<&::models::SessionStatus> {
    self.status.as_ref()
  }
