...
pub struct ApplicationSettings {
  ...
  notifications: Option<::models::ApplicationSettingsNotifications>
}
...
impl ApplicationSettings {
  ...
  pub fn set_notifications(&mut self, notifications: ::models::ApplicationSettingsNotifications) {
    self.notifications = Some(notifications);
  }

  pub fn with_notifications(mut self, notifications: ::models::ApplicationSettingsNotifications) -> ApplicationSettings {
    self.notifications = Some(notifications);
    self
  }

  pub fn notifications(&self) -> Option<&::models::ApplicationSettingsNotifications> {
