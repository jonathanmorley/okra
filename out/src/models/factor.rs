...
pub struct Factor {
  ...
  factor_type: Option<::models::FactorType>,
  #[serde(rename = "id")]
  id: Option<String>,
...
impl Factor {
  ...
  pub fn with_factor_type(mut self, factor_type: ::models::FactorType) -> Factor {
    self.factor_type = Some(factor_type);
    self
  }

  pub fn factor_type(&self) -> Option<&::models::FactorType> {
  ...
  pub fn with_provider(mut self, provider: ::models::FactorProvider) -> Factor {
    self.provider = Some(provider);
    self
  }

  pub fn provider(&self) -> Option<&::models::FactorProvider> {
  ...
  pub fn set_status(&mut self, status: ::models::FactorStatus) {
    self.status = Some(status);
  }

  pub fn with_status(mut self, status: ::models::FactorStatus) -> Factor {
    self.status = Some(status);
    self
  }

  pub fn status(&self) -> Option<&::models::FactorStatus> {
    self.status.as_ref()
  }
  ...
  pub fn set_verify(&mut self, verify: ::models::VerifyFactorRequest) {
    self.verify = Some(verify);
  }

  pub fn with_verify(mut self, verify: ::models::VerifyFactorRequest) -> Factor {
    self.verify = Some(verify);
    self
  }

  pub fn verify(&self) -> Option<&::models::VerifyFactorRequest> {
    self.verify.as_ref()
  }
