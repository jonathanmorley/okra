...
impl AuthenticationRequest {
  ...
  pub fn set_options(&mut self, options: ::models::Options) {
    self.options = Some(options);
  }

  pub fn with_options(mut self, options: ::models::Options) -> AuthenticationRequest {
    self.options = Some(options);
    self
  }

  pub fn options(&self) -> Option<&::models::Options> {
    self.options.as_ref()
  }
  ...
  pub fn set_context(&mut self, context: ::models::Context) {
    self.context = Some(context);
  }

  pub fn with_context(mut self, context: ::models::Context) -> AuthenticationRequest {
    self.context = Some(context);
    self
  }

  pub fn context(&self) -> Option<&::models::Context> {
    self.context.as_ref()
  }
