...
pub struct Group {
  ...
  profile: Option<::models::GroupProfile>,
  #[serde(rename = "type")]
  _type: Option<String>
}
...
impl Group {
  ...
  pub fn set_profile(&mut self, profile: ::models::GroupProfile) {
    self.profile = Some(profile);
  }

  pub fn with_profile(mut self, profile: ::models::GroupProfile) -> Group {
    self.profile = Some(profile);
    self
  }

  pub fn profile(&self) -> Option<&::models::GroupProfile> {
    self.profile.as_ref()
  }
