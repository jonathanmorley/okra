...
pub struct LogClient {
  ...
  geographical_context: Option<::models::LogGeographicalContext>,
  #[serde(rename = "id")]
  id: Option<String>,
  #[serde(rename = "ipAddress")]
  ip_address: Option<String>,
  #[serde(rename = "userAgent")]
  user_agent: Option<::models::LogUserAgent>,
  #[serde(rename = "zone")]
  zone: Option<String>
}
...
impl LogClient {
  ...
  pub fn set_geographical_context(&mut self, geographical_context: ::models::LogGeographicalContext) {
    self.geographical_context = Some(geographical_context);
  }

  pub fn with_geographical_context(mut self, geographical_context: ::models::LogGeographicalContext) -> LogClient {
    self.geographical_context = Some(geographical_context);
    self
  }

  pub fn geographical_context(&self) -> Option<&::models::LogGeographicalContext> {
  ...
  pub fn set_user_agent(&mut self, user_agent: ::models::LogUserAgent) {
    self.user_agent = Some(user_agent);
  }

  pub fn with_user_agent(mut self, user_agent: ::models::LogUserAgent) -> LogClient {
    self.user_agent = Some(user_agent);
    self
  }

  pub fn user_agent(&self) -> Option<&::models::LogUserAgent> {
