...
pub struct ApplicationVisibility {
  ...
  #[serde(rename = "hide")]
  hide: Option<::models::ApplicationVisibilityHide>
}
...
impl ApplicationVisibility {
  ...
  pub fn set_hide(&mut self, hide: ::models::ApplicationVisibilityHide) {
    self.hide = Some(hide);
  }

  pub fn with_hide(mut self, hide: ::models::ApplicationVisibilityHide) -> ApplicationVisibility {
    self.hide = Some(hide);
    self
  }

  pub fn hide(&self) -> Option<&::models::ApplicationVisibilityHide> {
    self.hide.as_ref()
  }
