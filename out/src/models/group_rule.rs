...
pub struct GroupRule {
  ...
  actions: Option<::models::GroupRuleAction>,
  #[serde(rename = "allGroupsValid")]
  all_groups_valid: Option<bool>,
  #[serde(rename = "conditions")]
  conditions: Option<::models::GroupRuleConditions>,
  ...
  name: Option<String>,
  #[serde(rename = "status")]
  status: Option<::models::GroupRuleStatus>,
  #[serde(rename = "type")]
  _type: Option<String>
}
...
impl GroupRule {
  ...
  pub fn set_actions(&mut self, actions: ::models::GroupRuleAction) {
    self.actions = Some(actions);
  }

  pub fn with_actions(mut self, actions: ::models::GroupRuleAction) -> GroupRule {
    self.actions = Some(actions);
    self
  }

  pub fn actions(&self) -> Option<&::models::GroupRuleAction> {
    self.actions.as_ref()
  }
  ...
  pub fn set_conditions(&mut self, conditions: ::models::GroupRuleConditions) {
    self.conditions = Some(conditions);
  }

  pub fn with_conditions(mut self, conditions: ::models::GroupRuleConditions) -> GroupRule {
    self.conditions = Some(conditions);
    self
  }

  pub fn conditions(&self) -> Option<&::models::GroupRuleConditions> {
  ...
  pub fn set_status(&mut self, status: ::models::GroupRuleStatus) {
    self.status = Some(status);
  }

  pub fn with_status(mut self, status: ::models::GroupRuleStatus) -> GroupRule {
    self.status = Some(status);
    self
  }

  pub fn status(&self) -> Option<&::models::GroupRuleStatus> {
    self.status.as_ref()
  }
