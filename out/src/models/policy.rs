...
pub struct Policy {
  ...
  system: Option<bool>,
  #[serde(rename = "type")]
  _type: Option<::models::PolicyType>
}
...
impl Policy {
  ...
  pub fn set__type(&mut self, _type: ::models::PolicyType) {
    self._type = Some(_type);
  }

  pub fn with__type(mut self, _type: ::models::PolicyType) -> Policy {
    self._type = Some(_type);
    self
  }

  pub fn _type(&self) -> Option<&::models::PolicyType> {
    self._type.as_ref()
  }
