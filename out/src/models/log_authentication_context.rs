...
pub struct LogAuthenticationContext {
  ...
  authentication_provider: Option<::models::LogAuthenticationProvider>,
  #[serde(rename = "authenticationStep")]
  authentication_step: Option<i32>,
  #[serde(rename = "credentialProvider")]
  credential_provider: Option<Vec<::models::LogCredentialProvider>>,
  #[serde(rename = "credentialType")]
  credential_type: Option<Vec<::models::LogCredentialType>>,
  #[serde(rename = "externalSessionId")]
  external_session_id: Option<String>,
  #[serde(rename = "interface")]
  interface: Option<String>,
  #[serde(rename = "issuer")]
  issuer: Option<::models::LogIssuer>
}
...
impl LogAuthenticationContext {
  ...
  pub fn set_authentication_provider(&mut self, authentication_provider: ::models::LogAuthenticationProvider) {
    self.authentication_provider = Some(authentication_provider);
  }

  pub fn with_authentication_provider(mut self, authentication_provider: ::models::LogAuthenticationProvider) -> LogAuthenticationContext {
    self.authentication_provider = Some(authentication_provider);
    self
  }

  pub fn authentication_provider(&self) -> Option<&::models::LogAuthenticationProvider> {
  ...
  pub fn set_credential_provider(&mut self, credential_provider: Vec<::models::LogCredentialProvider>) {
    self.credential_provider = Some(credential_provider);
  }

  pub fn with_credential_provider(mut self, credential_provider: Vec<::models::LogCredentialProvider>) -> LogAuthenticationContext {
    self.credential_provider = Some(credential_provider);
    self
  }

  pub fn credential_provider(&self) -> Option<&Vec<::models::LogCredentialProvider>> {
  ...
  pub fn set_credential_type(&mut self, credential_type: Vec<::models::LogCredentialType>) {
    self.credential_type = Some(credential_type);
  }

  pub fn with_credential_type(mut self, credential_type: Vec<::models::LogCredentialType>) -> LogAuthenticationContext {
    self.credential_type = Some(credential_type);
    self
  }

  pub fn credential_type(&self) -> Option<&Vec<::models::LogCredentialType>> {
  ...
  pub fn set_issuer(&mut self, issuer: ::models::LogIssuer) {
    self.issuer = Some(issuer);
  }

  pub fn with_issuer(mut self, issuer: ::models::LogIssuer) -> LogAuthenticationContext {
    self.issuer = Some(issuer);
    self
  }

  pub fn issuer(&self) -> Option<&::models::LogIssuer> {
    self.issuer.as_ref()
  }
