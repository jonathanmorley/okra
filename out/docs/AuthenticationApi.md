...
> ::models::AuthenticationTransaction auth_activate_factor(ctx, factor_id, body)
...
[**::models::AuthenticationTransaction**](AuthenticationTransaction.md)
...
> ::models::AuthenticationTransaction auth_change_password(ctx, body)
...
# **auth_verify_factor**
> ::models::AuthenticationTransaction auth_verify_factor(ctx, factor_id, body, optional)
...
# **authenticate**
> ::models::AuthenticationTransaction authenticate(ctx, body)
...
# **enroll_factor**
> ::models::AuthenticationTransaction enroll_factor(ctx, body)
