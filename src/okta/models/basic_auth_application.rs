...
pub struct r#BasicAuthApplication {
    #[serde(rename = "credentials", skip_serializing_if = "Option::is_none")]
    r#credentials: Option<SchemeApplicationCredentials>,
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    r#settings: Option<BasicApplicationSettings>,
}

impl r#BasicAuthApplication {
    pub fn new(
    ) -> Self {
        Self {
          r#credentials: None,
    ...
    pub fn set_settings(&mut self, r#settings: BasicApplicationSettings) {
        self.r#settings = Some(r#settings);
    }

    pub fn with_settings(mut self, r#settings: BasicApplicationSettings) -> Self {
        self.r#settings = Some(r#settings);
        self
    }

    pub fn r#settings(&self) -> Option<&BasicApplicationSettings> {
