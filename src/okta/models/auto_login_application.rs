...
pub struct r#AutoLoginApplication {
    #[serde(rename = "credentials", skip_serializing_if = "Option::is_none")]
    r#credentials: Option<SchemeApplicationCredentials>,
    #[serde(rename = "settings", skip_serializing_if = "Option::is_none")]
    r#settings: Option<AutoLoginApplicationSettings>,
}

impl r#AutoLoginApplication {
    pub fn new(
    ) -> Self {
        Self {
          r#credentials: None,
    ...
    pub fn set_settings(&mut self, r#settings: AutoLoginApplicationSettings) {
        self.r#settings = Some(r#settings);
    }

    pub fn with_settings(mut self, r#settings: AutoLoginApplicationSettings) -> Self {
        self.r#settings = Some(r#settings);
        self
    }

    pub fn r#settings(&self) -> Option<&AutoLoginApplicationSettings> {
