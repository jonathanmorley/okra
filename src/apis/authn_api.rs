...
impl<C: hyper::client::Connect>SessionApi for SessionApiClient<C> {
    ...
    fn end_session(&self, session_id: &str) -> Box<Future<Item = (), Error = Error<serde_json::Value>>> {
        _internal_request::Request::new(hyper::Method::Delete, "/api/v1/sessions/{sessionId}".to_string())
            .with_auth(_internal_request::Auth::ApiKey(_internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "Authorization".to_owned(),
    ...
    fn get_session(&self, session_id: &str) -> Box<Future<Item = crate::models::Session, Error = Error<serde_json::Value>>> {
        _internal_request::Request::new(hyper::Method::Get, "/api/v1/sessions/{sessionId}".to_string())
            .with_auth(_internal_request::Auth::ApiKey(_internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "Authorization".to_owned(),
    ...
    fn refresh_session(&self, session_id: &str) -> Box<Future<Item = crate::models::Session, Error = Error<serde_json::Value>>> {
        _internal_request::Request::new(hyper::Method::Post, "/api/v1/sessions/{sessionId}/lifecycle/refresh".to_string())
            .with_auth(_internal_request::Auth::ApiKey(_internal_request::ApiKey{
                in_header: true,
                in_query: false,
                param_name: "Authorization".to_owned(),
