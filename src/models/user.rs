...
pub struct User {
  ...
  credentials: Option<crate::models::UserCredentials>,
  #[serde(rename = "id")]
  id: Option<String>,
  ...
  transitioning_to_status: Option<crate::models::UserStatus>
}
...
impl User {
  ...
  pub fn with_embedded(mut self, _embedded: ::std::collections::HashMap<String, Value>) -> User {
    self._embedded = Some(_embedded);
    self
  }
  ...
  pub fn with_links(mut self, _links: ::std::collections::HashMap<String, Value>) -> User {
    self._links = Some(_links);
    self
  }
  ...
  pub fn set_credentials(&mut self, credentials: crate::models::UserCredentials) {
    self.credentials = Some(credentials);
  }

  pub fn with_credentials(mut self, credentials: crate::models::UserCredentials) -> User {
    self.credentials = Some(credentials);
    self
  }

  pub fn credentials(&self) -> Option<&crate::models::UserCredentials> {
  ...
  pub fn set_profile(&mut self, profile: crate::models::UserProfile) {
    self.profile = Some(profile);
  }

  pub fn with_profile(mut self, profile: crate::models::UserProfile) -> User {
    self.profile = Some(profile);
    self
  }

  pub fn profile(&self) -> Option<&crate::models::UserProfile> {
    self.profile.as_ref()
  }
  ...
  pub fn set_status(&mut self, status: crate::models::UserStatus) {
    self.status = Some(status);
  }

  pub fn with_status(mut self, status: crate::models::UserStatus) -> User {
    self.status = Some(status);
    self
  }

  pub fn status(&self) -> Option<&crate::models::UserStatus> {
    self.status.as_ref()
  }
  ...
  pub fn set_transitioning_to_status(&mut self, transitioning_to_status: crate::models::UserStatus) {
    self.transitioning_to_status = Some(transitioning_to_status);
  }

  pub fn with_transitioning_to_status(mut self, transitioning_to_status: crate::models::UserStatus) -> User {
    self.transitioning_to_status = Some(transitioning_to_status);
    self
  }

  pub fn transitioning_to_status(&self) -> Option<&crate::models::UserStatus> {
