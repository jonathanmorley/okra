...
pub struct SamlApplicationSettingsSignOn {
  ...
  attribute_statements: Option<Vec<crate::models::SamlAttributeStatement>>,
...
impl SamlApplicationSettingsSignOn {
  ...
  pub fn set_attribute_statements(&mut self, attribute_statements: Vec<crate::models::SamlAttributeStatement>) {
    self.attribute_statements = Some(attribute_statements);
  }

  pub fn with_attribute_statements(mut self, attribute_statements: Vec<crate::models::SamlAttributeStatement>) -> SamlApplicationSettingsSignOn {
    self.attribute_statements = Some(attribute_statements);
    self
  }

  pub fn attribute_statements(&self) -> Option<&Vec<crate::models::SamlAttributeStatement>> {
