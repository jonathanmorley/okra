...
pub struct AuthenticationTransaction {
  ...
  #[serde(rename = "status")]
  status: Option<crate::models::TransactionState>,
...
impl AuthenticationTransaction {
  ...
  pub fn with_type(mut self, _type: String) -> AuthenticationTransaction {
    self._type = Some(_type);
    self
  }
  ...
  pub fn set_status(&mut self, status: crate::models::TransactionState) {
    self.status = Some(status);
  }

  pub fn with_status(mut self, status: crate::models::TransactionState) -> AuthenticationTransaction {
    self.status = Some(status);
    self
  }

  pub fn status(&self) -> Option<&crate::models::TransactionState> {
    self.status.as_ref()
  }
  ...
  pub fn with_factor_result(mut self, factor_result: crate::models::FactorResultType) -> AuthenticationTransaction {
    self.factor_result = Some(factor_result);
    self
  }
  ...
  pub fn with_embedded(mut self, _embedded: ::std::collections::HashMap<String, Value>) -> AuthenticationTransaction {
    self._embedded = Some(_embedded);
    self
  }
  ...
  pub fn with_links(mut self, _links: ::std::collections::HashMap<String, Value>) -> AuthenticationTransaction {
    self._links = Some(_links);
    self
  }
