...
pub struct OpenIdConnectApplicationSettingsClient {
  ...
  application_type: Option<crate::models::OpenIdConnectApplicationType>,
  #[serde(rename = "client_uri")]
  client_uri: Option<String>,
  #[serde(rename = "consent_method")]
  consent_method: Option<crate::models::OpenIdConnectApplicationConsentMethod>,
  #[serde(rename = "grant_types")]
  grant_types: Option<Vec<crate::models::OAuthGrantType>>,
  ...
  response_types: Option<Vec<crate::models::OAuthResponseType>>,
...
impl OpenIdConnectApplicationSettingsClient {
  ...
  pub fn set_application_type(&mut self, application_type: crate::models::OpenIdConnectApplicationType) {
    self.application_type = Some(application_type);
  }

  pub fn with_application_type(mut self, application_type: crate::models::OpenIdConnectApplicationType) -> OpenIdConnectApplicationSettingsClient {
    self.application_type = Some(application_type);
    self
  }

  pub fn application_type(&self) -> Option<&crate::models::OpenIdConnectApplicationType> {
  ...
  pub fn set_consent_method(&mut self, consent_method: crate::models::OpenIdConnectApplicationConsentMethod) {
    self.consent_method = Some(consent_method);
  }

  pub fn with_consent_method(mut self, consent_method: crate::models::OpenIdConnectApplicationConsentMethod) -> OpenIdConnectApplicationSettingsClient {
    self.consent_method = Some(consent_method);
    self
  }

  pub fn consent_method(&self) -> Option<&crate::models::OpenIdConnectApplicationConsentMethod> {
  ...
  pub fn set_grant_types(&mut self, grant_types: Vec<crate::models::OAuthGrantType>) {
    self.grant_types = Some(grant_types);
  }

  pub fn with_grant_types(mut self, grant_types: Vec<crate::models::OAuthGrantType>) -> OpenIdConnectApplicationSettingsClient {
    self.grant_types = Some(grant_types);
    self
  }

  pub fn grant_types(&self) -> Option<&Vec<crate::models::OAuthGrantType>> {
  ...
  pub fn set_response_types(&mut self, response_types: Vec<crate::models::OAuthResponseType>) {
    self.response_types = Some(response_types);
  }

  pub fn with_response_types(mut self, response_types: Vec<crate::models::OAuthResponseType>) -> OpenIdConnectApplicationSettingsClient {
    self.response_types = Some(response_types);
    self
  }

  pub fn response_types(&self) -> Option<&Vec<crate::models::OAuthResponseType>> {
