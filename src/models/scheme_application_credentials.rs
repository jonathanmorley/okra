...
pub struct SchemeApplicationCredentials {
  ...
  #[serde(rename = "scheme")]
  scheme: Option<crate::models::ApplicationCredentialsScheme>,
...
impl SchemeApplicationCredentials {
  ...
  pub fn with_password(mut self, password: crate::models::PasswordCredential) -> SchemeApplicationCredentials {
    self.password = Some(password);
    self
  }
  ...
  pub fn set_scheme(&mut self, scheme: crate::models::ApplicationCredentialsScheme) {
    self.scheme = Some(scheme);
  }

  pub fn with_scheme(mut self, scheme: crate::models::ApplicationCredentialsScheme) -> SchemeApplicationCredentials {
    self.scheme = Some(scheme);
    self
  }

  pub fn scheme(&self) -> Option<&crate::models::ApplicationCredentialsScheme> {
    self.scheme.as_ref()
  }
  ...
  pub fn with_signing(mut self, signing: crate::models::ApplicationCredentialsSigning) -> SchemeApplicationCredentials {
    self.signing = Some(signing);
    self
  }
