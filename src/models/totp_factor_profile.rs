...
pub struct TotpFactorProfile {
  #[serde(rename = "credentialId")]
  credential_id: Option<String>
}

impl TotpFactorProfile {
  pub fn new() -> TotpFactorProfile {
    TotpFactorProfile {
      credential_id: None
    }
  }
  ...
  pub fn with_credential_id(mut self, credential_id: String) -> TotpFactorProfile {
    self.credential_id = Some(credential_id);
    self
  }
