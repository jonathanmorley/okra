...
pub struct AppUser {
  ...
  credentials: Option<crate::models::AppUserCredentials>,
...
impl AppUser {
  ...
  pub fn with_embedded(mut self, _embedded: ::std::collections::HashMap<String, Value>) -> AppUser {
    self._embedded = Some(_embedded);
    self
  }
  ...
  pub fn with_links(mut self, _links: ::std::collections::HashMap<String, Value>) -> AppUser {
    self._links = Some(_links);
    self
  }
  ...
  pub fn set_credentials(&mut self, credentials: crate::models::AppUserCredentials) {
    self.credentials = Some(credentials);
  }

  pub fn with_credentials(mut self, credentials: crate::models::AppUserCredentials) -> AppUser {
    self.credentials = Some(credentials);
    self
  }

  pub fn credentials(&self) -> Option<&crate::models::AppUserCredentials> {
