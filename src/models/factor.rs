...
impl Factor {
  ...
  pub fn with_embedded(mut self, _embedded: ::std::collections::HashMap<String, Value>) -> Factor {
    self._embedded = Some(_embedded);
    self
  }
  ...
  pub fn with_links(mut self, _links: ::std::collections::HashMap<String, Value>) -> Factor {
    self._links = Some(_links);
    self
  }
