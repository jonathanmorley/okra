...
pub struct PasswordPolicyPasswordSettingsComplexity {
  ...
  dictionary: Option<crate::models::PasswordDictionary>,
...
impl PasswordPolicyPasswordSettingsComplexity {
  ...
  pub fn set_dictionary(&mut self, dictionary: crate::models::PasswordDictionary) {
    self.dictionary = Some(dictionary);
  }

  pub fn with_dictionary(mut self, dictionary: crate::models::PasswordDictionary) -> PasswordPolicyPasswordSettingsComplexity {
    self.dictionary = Some(dictionary);
    self
  }

  pub fn dictionary(&self) -> Option<&crate::models::PasswordDictionary> {
