...
pub struct ApplicationCredentialsOAuthClient {
  ...
  token_endpoint_auth_method: Option<crate::models::OAuthEndpointAuthenticationMethod>
}
...
impl ApplicationCredentialsOAuthClient {
  ...
  pub fn set_token_endpoint_auth_method(&mut self, token_endpoint_auth_method: crate::models::OAuthEndpointAuthenticationMethod) {
    self.token_endpoint_auth_method = Some(token_endpoint_auth_method);
  }

  pub fn with_token_endpoint_auth_method(mut self, token_endpoint_auth_method: crate::models::OAuthEndpointAuthenticationMethod) -> ApplicationCredentialsOAuthClient {
    self.token_endpoint_auth_method = Some(token_endpoint_auth_method);
    self
  }

  pub fn token_endpoint_auth_method(&self) -> Option<&crate::models::OAuthEndpointAuthenticationMethod> {
