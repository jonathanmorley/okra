...
impl AuthenticationProvider {
  ...
  pub fn set_type(&mut self, _type: crate::models::AuthenticationProviderType) {
    self._type = Some(_type);
  }

  pub fn with_type(mut self, _type: crate::models::AuthenticationProviderType) -> AuthenticationProvider {
    self._type = Some(_type);
    self
  }
