...
pub struct SecurePasswordStoreApplication {
  ...
  settings: Option<crate::models::SecurePasswordStoreApplicationSettings>
}
...
impl SecurePasswordStoreApplication {
  ...
  pub fn with_credentials(mut self, credentials: crate::models::SchemeApplicationCredentials) -> SecurePasswordStoreApplication {
    self.credentials = Some(credentials);
    self
  }
  ...
  pub fn set_settings(&mut self, settings: crate::models::SecurePasswordStoreApplicationSettings) {
    self.settings = Some(settings);
  }

  pub fn with_settings(mut self, settings: crate::models::SecurePasswordStoreApplicationSettings) -> SecurePasswordStoreApplication {
    self.settings = Some(settings);
    self
  }

  pub fn settings(&self) -> Option<&crate::models::SecurePasswordStoreApplicationSettings> {
