...
pub struct ApplicationSettingsNotificationsVpn {
  ...
  network: Option<crate::models::ApplicationSettingsNotificationsVpnNetwork>
}
...
impl ApplicationSettingsNotificationsVpn {
  ...
  pub fn set_network(&mut self, network: crate::models::ApplicationSettingsNotificationsVpnNetwork) {
    self.network = Some(network);
  }

  pub fn with_network(mut self, network: crate::models::ApplicationSettingsNotificationsVpnNetwork) -> ApplicationSettingsNotificationsVpn {
    self.network = Some(network);
    self
  }

  pub fn network(&self) -> Option<&crate::models::ApplicationSettingsNotificationsVpnNetwork> {
    self.network.as_ref()
  }
