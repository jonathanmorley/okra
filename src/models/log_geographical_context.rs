...
pub struct LogGeographicalContext {
  ...
  geolocation: Option<crate::models::LogGeolocation>,
...
impl LogGeographicalContext {
  ...
  pub fn set_geolocation(&mut self, geolocation: crate::models::LogGeolocation) {
    self.geolocation = Some(geolocation);
  }

  pub fn with_geolocation(mut self, geolocation: crate::models::LogGeolocation) -> LogGeographicalContext {
    self.geolocation = Some(geolocation);
    self
  }

  pub fn geolocation(&self) -> Option<&crate::models::LogGeolocation> {
